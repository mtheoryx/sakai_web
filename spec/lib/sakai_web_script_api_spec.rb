...
describe "#list_tools_for_site" do
  ...
  it "should return a list of tools for a given site" do
    # pending "Format a hash of tool names and tool IDs"
...
describe "#add_property_to_site" do
  ...
  it "should see if the property already exists" do
    pending "See what existing test properties I can look up."
    param = {
      :property_name => "site.type.pdp",
      :property_value => "true"
    }
  end
